...
const deploymentMarker = 'hostinger-stable-startup-2026-05-18-04';
...
function runtimePayload(extra = {}) {
  return {
    ...
    guidance: [
      ...
      'Hostinger now runs the real next build during deployment, so .next should exist before startup.',
      'Runtime install and runtime rebuild were removed to avoid startup loops, long boot windows, and process manager 503 behavior.',
